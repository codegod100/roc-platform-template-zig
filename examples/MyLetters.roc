# ported from https://github.com/imclerran/roc-asciiart
...
## Convert a string to a list of AsciiLetter objects.
str_to_ascii_letters : Str -> List(AsciiLetter)
str_to_ascii_letters = |s|
    List.map(Str.to_utf8(s), char_to_ascii_letter)
